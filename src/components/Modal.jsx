...
function Modal( {closeModal} ) {
    ...
    return (
        <div className="bg-slate-950 flex flex-col items-center justify-center h-screen p-4">
            <div className="bg-slate-900 p-7 rounded-md shadow-lg flex flex-col relative">
                ...
                <div className="flex flex-col space-y-3 mt-8">
                    <button className="px-8 py-2 bg-slate-700 hover:bg-slate-600 rounded-md text-white cursor-pointer" onClick={() => closeModal(false)}>Save</button>
                </div>
            </div>
        </div>
    );
